...
if(!empty($_POST['url'])){
    ...
    $miniCrypt){
       ...
       /* $id_user  = "id_user"; // String
        ...
        system("rm -R /sysbig/tmpfile/".escapeshellcmd($id_user));
        system("mkdir /sysbig/tmpfile/".escapeshellcmd($id_user));
        system("cp -r /sysbig/sourceproject/mmm /sysbig/tmpfile/".escapeshellcmd($id_user)."/mmm");
        system("chmod -R 777 /sysbig/tmpfile/".escapeshellcmd($id_user));
        ...
        exec("cd /sysbig/tmpfile/".escapeshellcmd($id_user)."/mmm/ && ./gradlew assembleRelease");
